...
`jupyter-live-share-1.2.0.vsix` 파일이 생성됩니다.
...
code --install-extension "%~dp0jupyter-live-share-1.2.0.vsix" --force
if %errorlevel% equ 0 (
...
2. Tag: `v1.2.0`
3. Title: `v1.2.0 - 초기 릴리스`
4. Description: 변경사항 작성
5. **Attach binaries**: `jupyter-live-share-1.2.0.vsix` 파일 첨부
6. **Publish release**
...
gh release create v1.2.0 jupyter-live-share-1.2.0.vsix \
  --title "v1.2.0 - 초기 릴리스" \
...
# Open VSX에 배포
ovsx publish jupyter-live-share-1.2.0.vsix -p <YOUR_TOKEN>
```
...
```
https://your-school-site.com/extensions/jupyter-live-share-1.2.0.vsix
```
...
<ol>
  <li><a href="jupyter-live-share-1.2.0.vsix">Extension 다운로드</a></li>
...
code --install-extension jupyter-live-share-1.2.0.vsix --force
```
